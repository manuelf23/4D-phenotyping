...
pcd_frame = pd.read_csv(
    "/Users/manuelgarciarincon/Proyectos_python/personal/calibracion/centro_lidar/centro.csv")
...
################# FILTER PCD POINTS BY DISTANCE #################
print(pcd_frame['X'].max())
print(pcd_frame['X'].idxmax())
print(pcd_frame['laser_id'][pcd_frame['Z'].idxmax()])
...
target_pcd = centro_pcd[(pcd_frame.Z >= -0.48)]  # 5'
# target_pcd = centro_pcd[(pcd_frame.Z >= -0.53)]  # 5

print('centro X:', pcd_frame['X'].mean())
print('centro Y:', pcd_frame['Y'].mean())
